...
function selectChoice(choice) {
    ...
    let htmlUser = `<img src="./assets/images/icon-${choice}.png" alt="${choice}" class='choice--img'/>`;
    // Update the user's choice display by adding an image of the choice to the userChoiceDisplay html element
    userChoiceDisplay.innerHTML = htmlUser;
...
function playGame() {
    ...
    const computerChoice = getComputerChoice(choices);// call the computer choice function
    ...
    let htmlComputer = `<img src="./assets/images/icon-${computerChoice}.png" alt="${computerChoice}" class='choice--img'/>`;
    ...
    computerChoiceDisplay.innerHTML = htmlComputer;
